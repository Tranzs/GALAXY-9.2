...
const students = [
  ...
  { name: "Minh Khoa", x: 30, y: 14, size: 24, color: "#ff61d8", shape: "crystal", trait: "The Exam Devourer", message: "You have learned how to keep moving even when a question looks unfamiliar. Trust that patience.", future: "Target: High School No.1" },
  ...
  { name: "Minh Thư", x: 84, y: 22, size: 23, color: "#ffd166", shape: "diamond", trait: "The Expressive Moon", message: "Listening to your emotion. Your answers would be calm, clean, and clear. Let each sentence land exactly where it should.", future: "Target: Humanities Track" },
  { name: "Vân Khánh", x: 8, y: 43, size: 29, color: "#8fb7ff", shape: "halo", trait: "The Rapid Nova", message: "You improve quickly like a bright nova, but in the test, slow down, read carefully, and let your hard work shine.", future: "Target: Confident New Beginning" },
  ...
  { name: "Phương Nhi", x: 69, y: 36, size: 27, color: "#afc8ff", shape: "binary", trait: "The North Star", message: "Keep your smile, but bring your sharpest focus. You are ready for more than you think.", future: "Target: To be the Brightest Stella" },
...
const spacePortalFrame = document.querySelector("#spacePortalFrame");
...
function openStudent(index) {
  ...
  triggerWarp();
  if (student.name === "Future Star") {
    window.setTimeout(openInfiniteSpace, 420);
    return;
  }
